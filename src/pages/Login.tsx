  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        {/* Don't have the app? */}
        <div className="bg-slate-900 rounded-2xl p-5 mt-4 space-y-4">
          ...
          <div className="flex gap-3">
            <a href="https://play.google.com/store/apps/details?id=com.flashid.app" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center gap-3 py-3 px-4 bg-slate-800 border border-slate-600 rounded-xl hover:bg-slate-700 transition-colors">
              <svg className="w-6 h-6 text-white flex-shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 01-.61-.92V2.734a1 1 0 01.609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.199l2.454 1.42a1 1 0 010 1.735l-2.454 1.42-2.537-2.537 2.537-2.038zM5.864 2.658L16.8 8.99l-2.302 2.302-8.634-8.634z" /></svg>
            ...
            <a href="https://apps.apple.com/app/flashid" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center gap-3 py-3 px-4 bg-slate-800 border border-slate-600 rounded-xl hover:bg-slate-700 transition-colors">
              <svg className="w-6 h-6 text-white flex-shrink-0" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" /></svg>
              <div className="text-left">

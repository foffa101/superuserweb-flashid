...
const allNavItems = [
  ...
  { to: '/consent-log', label: 'Consent', icon: FileCheck2 },
  { to: '/agents', label: 'Agents', icon: Bot, children: [
    { to: '/agents/field', label: 'Field Agents', icon: Shield },
    { to: '/agents/business', label: 'AI Agents', icon: Building2 },
...
const pageInfo: Record<string, { icon: LucideIcon; title: string; subtitle: string }> = {
  ...
  '/agents/business': { icon: Building2, title: 'AI Agents', subtitle: 'Manage AI agent registrations and configurations' },
  ...
  '/consent-log': { icon: FileCheck2, title: 'Consent', subtitle: 'Immutable audit trail of site authorizations' },
